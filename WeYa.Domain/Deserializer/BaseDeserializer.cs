...
namespace WeYa.Domain
{
    public abstract class BaseDeserializer
    {
        ...
        public abstract Task WriteObject<T>(string path,T content);
        public abstract Task WriteObject<T>(T content);
        /// <summary>
        /// 反序列化对象列表.
        /// </summary>
        ...
        //public abstract DataResult ReadIsSuccess(string content);
    }
}
